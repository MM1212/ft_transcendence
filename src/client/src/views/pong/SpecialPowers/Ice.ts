...
export class UIIce extends Ice {
  ...
  constructor(
    ...
    AnimationConstructor(
      {
        path: `${PongModel.Endpoints.Targets.IceWalk}/IceWalk`,
        json: `${PongModel.Endpoints.Targets.IceWalkJSON}`,
        frames: 4,
      },
      {
        path: `${PongModel.Endpoints.Targets.IceDies}/IceDies`,
        json: `${PongModel.Endpoints.Targets.IceDiesJSON}`,
        frames: 10,
      }
