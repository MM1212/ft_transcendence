...
import { AvatarGroup, Box, Sheet, Stack, Tooltip, Typography } from "@mui/joy";
  ...
  return (
    <>
      ...
      >
        ...
        >
          {Math.random() > 0.5 ? (
            <Typography level="h4" textTransform="uppercase" ml={0} textColor={"primary.200"}>
              Victory
            </Typography>
          ) : (
            <Typography level="h4" textTransform="uppercase" ml={0} textColor={"danger.400"}>
              Defeat
            </Typography>
          )}
          <Stack
