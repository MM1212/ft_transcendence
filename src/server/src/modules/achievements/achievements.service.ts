...
export class AchievementsService {
    ...
    public readonly config: Map<string, AchievementsModel.Models.IAchievement> = new Map();
    constructor() {
        this.loadConfig();
    }
    ...
    public getAllWithQuests(questTag: string): AchievementsModel.Models.IAchievement[] {
